...
<head>
   ...
   <title><?php echo $_GET['search']; ?> Search - Raza Product</title>
   <!-- Favicon Icon -->
...
<body>
   ...
   <section class="pt-3 pb-3 page-info section-padding border-bottom bg-white">
      <div class="container">
         <div class="row">
            <div class="col-md-12">
               <a href="/"><strong><span class="mdi mdi-home"></span> Home</strong></a> <span class="mdi mdi-chevron-right"></span> <a href="#"><?php echo $_GET['search']; ?></a>
            </div>
         </div>
      </div>
   </section>
         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <div class="row no-gutters">
                  ...
                  $sql3 = "SELECT * FROM products WHERE name LIKE '%{$search_term}%'";
