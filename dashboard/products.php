                        ...
                        <div class="widget">
                           ...
                           ?>
                                 <tr>
                                    ...
                                    <td style="vertical-align: middle;">₹<?php echo $row['discount']; ?></td>
                                    <td style="vertical-align: middle;"><?php echo $row['stock']==1?'Yes':'No'; ?></td>
                           ...
                           <?php
                              ...
                              if (mysqli_num_rows($result2) > 4) {
                                 ...
                                 if ($page > 1) {
                                    echo "<a href='products.php?page=" . ($page - 1) . "' class='btn btn-info btn-sm mx-1'>Prev<a>";
                                 }
                                 ...
                                 for ($i = 1; $i <= $total_pages; $i++) {
                                    if ($i == $page) {
                                       echo "<a href='products.php?page=" . $i . "' class='btn btn-info btn-sm mx-1 active'>" . $i . "<a>";
                                    } else {
                                       echo "<a href='products.php?page=" . $i . "' class='btn btn-info btn-sm mx-1'>" . $i . "<a>";
                                    }
                                 }
                                 if ($page < $total_pages) {
                                    echo "<a href='products.php?page=" . ($page + 1) . "' class='btn btn-info btn-sm mx-1'>Next<a>";
                                 }
                                 echo "</div";
                              }
                           } else {
