                    ...
                    <div class="row no-gutters">
                        ...
                        if (isset($_POST['add-category'])) {
                            ...
                            if (mysqli_num_rows($result2) > 0) {
                                ...
                                $sql3 = "INSERT INTO categories (cat_name) VALUES ('{$cat_name}')";
                                if (mysqli_query($conn, $sql3)) {
                                    ...
                                    alertPopup('Category added successfully 😊!');
                                }
                            }
                            mysqli_close($conn);
                        }
                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 text-left">
                                                <input type="submit" value="Save" class="btn btn-success btn-lg" name="add-category">
                                            </div>
                                        </div>
                                    </form>
                                </div>
