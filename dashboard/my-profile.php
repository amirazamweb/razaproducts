            ...
            <div class="col-lg-9 mx-auto">
               <div class="row no-gutters">
                  ...
                  if (isset($_POST['save-changes'])) {
                     ...
                     $sql = "UPDATE users SET name = '{$name}', pet_name = '{$petname}', email = '{$email}', city = '{$city}', state = '{$state}', zip_code = '{$zip_code}', address = '{$address}' WHERE user_id = $user_id";

                     if (mysqli_query($conn, $sql)) {
                        alertPopup('User profiled changed successfully 😊!');
                     }
                     mysqli_close($conn);
                  }
                  ?>
                  ...
                  $sql = "SELECT * FROM users LEFT JOIN states ON users.city = states.state_id WHERE user_id = $user_id";
                                    ...
                                    <div class="row">
                                       <div class="col-sm-6">
                                          <div class="form-group">
                                             ...
                                             <input class="form-control border-form-control" value="<?php echo $row['name']; ?>" placeholder="Gurdeep" type="text" name="name" required>
                                          </div>
                                       </div>
                                       <div class="col-sm-6">
                                          <div class="form-group">
                                             <label class="control-label">Pet Name <span class="required">*</span></label>
                                             <input class="form-control border-form-control" value="<?php echo $row['pet_name']; ?>" placeholder="Osahan" type="text" name="petname" required>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="row">
                                       <div class="col-sm-6">
                                          <div class="form-group">
                                             ...
                                             <input class="form-control border-form-control" value="<?php echo $row['phone']; ?>" placeholder="123 456 7890" type="number" name="phone" readonly>
                                          </div>
                                       </div>
                                       <div class="col-sm-6">
                                          <div class="form-group">
                                             <label class="control-label">Email Address <span class="required">*</span></label>
                                             <input class="form-control border-form-control " value="<?php echo $row['email']; ?>" placeholder="iamosahan@gmail.com" type="email" name="email" required>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="row">
                                       <div class="col-sm-6">
                                          <div class="form-group">
                                             ...
                                             <input class="form-control border-form-control" value="<?php echo $row['role'] == '1' ? 'Admin' : 'User'; ?>" placeholder="" type="text" readonly>
                                          </div>
                                       </div>
                                       <div class="col-sm-6">
                                          <div class="form-group">
                                             <label class="control-label">City <span class="required">*</span></label>
                                             <input class="form-control border-form-control " value="<?php echo $row['city']; ?>" placeholder="Delhi" type="text" name="city" required>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="row">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <select class="select2 form-control border-form-control" name="state" required>
                                                ...
                                                while ($row2 = mysqli_fetch_assoc($result2)) {
                                                   if ($row['state'] == $row2['state_id']) {
                                                      echo '<option value="' . $row2['state_id'] . '" selected>' . $row2['state_name'] . '</option>';
                                                   } else {
                                       ...
                                       <div class="col-sm-6">
                                          <div class="form-group">
                                             ...
                                             <input class="form-control border-form-control" value="<?php echo $row['zip_code']; ?>" placeholder="123456" type="number" name="zip_code" required>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="row">
                                       <div class="col-sm-12">
                                          <div class="form-group">
                                             ...
                                             <textarea class="form-control border-form-control" name="address" required><?php echo $row['address']; ?></textarea>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="row">
                                       <div class="col-sm-12 text-right">
                                          <input type="submit" value="Save Changes" class="btn btn-success btn-lg" name="save-changes">
                                       </div>
                                    </div>
                                 </form>
                              </div>
