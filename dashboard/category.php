                        ...
                        <div class="card card-body account-right">
                           <div class="widget">
                              ...
                              <?php 
                                       ...
                                       $offset = ($page-1)*$limit;
                                       $sql = "SELECT * FROM categories ORDER BY cat_id DESC LIMIT {$offset}, {$limit}";
                                    ...
                                    <tbody>
                                     ...
                                     <tr>
                                          ...
                                          <td><a data-toggle="tooltip" data-placement="top" title="Edit" href="update-category.php?cat_id=<?php echo $row['cat_id']; ?>" data-original-title="View Detail" class="btn btn-info btn-sm"><i class="mdi mdi-border-color"></i></a>
                                          <a data-toggle="tooltip" data-placement="top" title="Delete" href="delete-category.php?cat_id=<?php echo $row['cat_id']; ?>" data-original-title="View Detail" class="btn btn-danger btn-sm"><i class="mdi mdi-delete"></i></a>
                                       </td>
                                       </tr>
                                       ...
                                       <?php  
                                        ...
                                        if(mysqli_num_rows($result2)>7){
                                          ...
                                          for($i=1; $i <= $total_pages; $i++){
                                           if($i==$page){
                                             echo "<a href='category.php?page=".$i."' class='btn btn-info btn-sm mx-1 active'>".$i."<a>"; 
                                           } 
                                           else{
                                             echo "<a href='category.php?page=".$i."' class='btn btn-info btn-sm mx-1'>".$i."<a>"; 
                                           }
                                          }
                                         if($page<$total_pages){
                                          echo "<a href='category.php?page=".($page+1)."' class='btn btn-info btn-sm mx-1'>Next<a>";
                                         }
                                          echo "</div";
                                        }
                                       }
