...
<head>
   ...
   <body>
     ...
     <?php
      ...
      <section class="shop-list section-padding">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="shop-head">
                     <h5 class="mb-3 fw-bolder">Fruits</h5>
                  </div>
      ...
      <script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="vendor/jquery/jquery.min.js" type="b907ec35c033d4b347859ecf-text/javascript"></script>
