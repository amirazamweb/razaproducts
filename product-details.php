               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="shop-detail-right">
                        ...
                        <?php
                        if ($row2['discount'] > 0) {
                           echo '<p class="offer-price mb-0" style="line-height:28px">Discounted price : <span class="text-success">₹' . number_format((($row2['price'] - $row2['discount'])), 2) . '</span></p>';
                        } else {
                        ...
                        <form action="" method="post">
                           ...
                           <button type="submit" name="addToCart" class="btn btn-secondary btn-lg"><i class="mdi mdi-cart-outline"></i> Add To Cart</button>
                        </form>
                  ...
                  <div class="product">
                     <a href="product-details.php?product_id=<?php echo $row4['product_id'] ?>">
                        ...
                        <div class="product-footer">
                           <form action="" method="post">
                              <input type="hidden" name="product_id2" value="<?php echo $row4['product_id'] ?>">
                              <button type="submit" class="btn btn-secondary btn-sm float-right" name="addToCart2"><i class="mdi mdi-cart-outline"></i> Add To Cart</button>
                           </form>
